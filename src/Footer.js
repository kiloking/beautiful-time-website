...
function Footer() {
  const [msgMailTitle,setMsgMailTitle] = useState('上順丰城艾麗網站的表單')
          ...
          <div className='md:w-full mx-auto'>
            <form onSubmit={handleSubmit(onSubmit)} className="w-full mx-auto pt-5  rel" data-aos="fade-up" data-aos-duration="1500" >
              ...
              <div className='flex flex-col w-full mx-auto gap-4 my-3 md:mt-8'>
                <button className='bg-[#C3181F]/30 px-2 py-2  font-bold w-full    text-md tracking-wide text-[#fff]' type='submit'>送出</button>
