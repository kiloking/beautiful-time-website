...
function Footer() {
  const [msgMailTitle,setMsgMailTitle] = useState('上順艾麗的表單')
  ...
  return (
    <div
      className='w-full h-full  bg-cover bg-bottom bg-no-repeat pt-20 relative bg-[#F1B4B9] '
      style={{
        backgroundImage: `url(${process.env.PUBLIC_URL +'/images/release/footer_bg.png'})`,
      }}
    >
      <div className='bg-[#E85C77]  absolute top-0 w-full p-4 flex justify-center'>
        <img src={process.env.PUBLIC_URL+'/images/release/footer_title.png'} alt="" data-aos="fade" data-aos-duration="1000" className='max-w-full md:w-1/3'/>
      </div>
      <div className='flex flex-col md:flex-row w-10/12 mx-auto gap-5 md:gap-14 py-1 pb-20 items-center'>
        <div className='md:w-1/2'>
          <img src={process.env.PUBLIC_URL+'/images/release/footer_p01.png'} alt="" data-aos="fade-up" data-aos-duration="1000"/>
        </div>
        <div className='w-4/5 md:w-1/2 mx-auto' >
          ...
          <div className='md:w-full mx-auto'>
            <form onSubmit={handleSubmit(onSubmit)} className="w-full mx-auto pt-5  rel" data-aos="fade-up" data-aos-duration="1500" >
              ...
              <div className='flex flex-col  mx-auto gap-4 my-3 md:mt-8'>
                <button className=' text-white bg-[#E85C77]  px-2 py-2  font-bold w-full    text-md tracking-wide rounded-full' type='submit'>確認送出</button>
