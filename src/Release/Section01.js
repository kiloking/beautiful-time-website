    ...
    >
      ...
      <div className='aspect-[747/1000]  w-full  relative  z-0  lg:hidden overflow-x-scroll ' ref={scrollContainerRef}> 
        ...
        <div className='w-[300vw]  h-full lg:min-h-[70vh] overflow-x-hidden overflow-y-hidden bg-bottom bg-cover bg-no-repeat transition-width'
          style={{backgroundImage: `url(${process.env.PUBLIC_URL +'/images/release/section01_bg.png'})`}}
        >
        </div>
      ...
      <div
        className='w-full bg-cover bg-no-repeat bg-center hidden lg:block mt-0 md:-mt-[20%] relative'
      //  style={{backgroundImage: `url(${process.env.PUBLIC_URL +'/images/release/section02_bg.png'})`}}
       >
        <div className='top-[24%] left-1/2 -translate-x-1/2  absolute flex  '><img src={process.env.PUBLIC_URL +'/images/release/section01_title.png'} alt="" className='max-w-full' /></div>
        <img src={process.env.PUBLIC_URL +'/images/release/section01_bg.png'} alt="" className='w-full' />
      </div>
